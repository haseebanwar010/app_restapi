...
//////////////////////////////////////////////////////////////////Script for Schools Table/////////////////////////////////////////////////////////////////
$record=mysqli_query($mobcon, 'SELECT sh_countries.id, sh_countries.country_code, sh_school.country FROM sh_school LEFT JOIN sh_countries ON sh_school.country=sh_countries.country_name');
$result=mysqli_fetch_all($record);

foreach($result as $row)
{
    $sql="UPDATE sh_school SET country_code='".$row[1]."' WHERE country='".$row[2]."' ";
